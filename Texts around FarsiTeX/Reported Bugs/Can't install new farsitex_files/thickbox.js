...
function TB_show(caption, url, rel) {
  ...
  if ( baseURL.match(imageURL) ) {
    ...
    imgPreloader.onload = function() {
      ...
      jQuery("#TB_window").append("<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='"+url+"' width='"+imageWidth+"' height='"+imageHeight+"' alt='"+caption+"'/></a>" + "<div id='TB_caption'>"+caption+"<div id='TB_secondLine'>" + imageCount + prev.html + next.html + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Close'>x</a></div>");
        ...
        jQuery("#TB_ajaxContent").load(url, function(){
          ...
          jQuery("#TB_window").css({display:"block"}); 
                        jQuery("ul.dynimo").find("li span").toggle(
                               function(){ jQuery(this).parent("li").find("ul").fadeIn("xfast"); jQuery(this).addClass("high"); },
                               function(){ jQuery(this).parent("li").find("ul").fadeOut("xfast"); jQuery(this).removeClass("high"); }
