...
\usepackage{pstricks,xecolour}
\usepackage{draftwatermark}
\usepackage{xepersian}
\settextfont[Scale=1]{XB Zar}
\setlatintextfont[Scale=1]{Linux Libertine}
\defpersianfont\Navar[Scale=2]{XB Kayhan Navaar}

\SetWatermarkText{\Navar \yellow{کارگاه آموزشی فارسی‌تِک}}
\SetWatermarkScale{.2}
\SetWatermarkLightness{.35}
...
\end{minipage}}}
\end{center}
\def\myText{ این نوشتار تحت سیستم حروف‌چینی {\LaTeX{}} با استفاده از بسته {\XePersian{}} آماده شده است.}
\footnotesize
\vfill\centerline{\green{\myText}}
\centerline{برای اطلاعات بیشتر درباره این بسته به سایت
